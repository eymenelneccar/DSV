      ...
      <div className="flex justify-end mb-8">
        <div className="w-80">
          <div className="bg-slate-50 p-4 rounded-lg space-y-3">
            ...
            <div className="flex justify-between py-2 text-lg font-bold bg-blue-50 px-4 rounded">
              <span>المجموع النهائي:</span>
              <span className="text-blue-600">{Number(transaction.total).toFixed(2)} ر.س</span>
            </div>
          </div>
        </div>
      </div>
